                      ...
                      const bool isTf8Buffer)
{
   ...
   {
      userBufferEncoding = std::move(std::unique_ptr<zdl::DlSystem::UserBufferEncodingTf8>(new zdl::DlSystem::UserBufferEncodingTf8(0,1.0)));
   }
   else
   {
      userBufferEncoding = std::move(std::unique_ptr<zdl::DlSystem::UserBufferEncodingFloat>(new zdl::DlSystem::UserBufferEncodingFloat()));
   }
